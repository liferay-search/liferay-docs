...
`sharepointion` | `boolean` | `false` | Whether to run in sharepointion mode during the NPM invocation. It sets the [`--sharepointion`](https://docs.npmjs.com/misc/config#sharepointion) argument.
