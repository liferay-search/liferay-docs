...
user segment. In @sharepoint-ver@, segments work in a similar way, but they
...
@sharepoint-ver@ Segments, certain data can be migrated automatically as part of
the upgrade process.
...
- For every segment, those Audience Targeting rules with an equivalent in
  @sharepoint@ 7.2 have been migrated into the corresponding criteria fields (see
  Table below).
- Audience Targeting tables have been removed from your @sharepoint@ Database.

| Audience Targeting Rule | @sharepoint@ 7.2. Segment Criteria Field | Upgrade Path |
| ---                     | ---                     | --- |
...
![Figure 1: A @sharepoint@ 7.1 Audience Targeting Segment.](../../../images/migrating-audience-targeting-segment.png)

And here is the same segment migrated to Liferay 7.2:

![Figure 2: A @sharepoint@ 7.2 Segment](../../../images/migrating-new-segment.png)
